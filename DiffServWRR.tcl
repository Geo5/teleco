...
set nf [open diff_serv_wrr_$w0.nam w]
$ns namtrace-all $nf

# Open the output trace file
set f [open diff_serv_wrr_$w0.tr w]
$ns trace-all $f
...
$q1 setSchedularMode WRR
$q1 addQueueWeights 0 $w0
...
$q2 setSchedularMode WRR
$q2 addQueueWeights 0 $w0
